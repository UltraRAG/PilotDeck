...
export function createReadFileTool(): PilotDeckToolDefinition<ReadFileInput> {
  return {
    ...
    description:
      ...
      + "- This tool allows 9GClaw to read images (eg PNG, JPG, etc). When reading an image file the contents are presented visually when the current model supports image input\n"
