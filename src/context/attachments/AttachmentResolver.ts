        ...
        diagnostics: [
          {
            code: "attachment_too_large",
            severity: "warning",
            message: `Image ${absolute} is ${info.size} bytes (limit ${this.maxImageBytes}); skipped (G9Claw does not resize, intentional_difference §4.5).`,
          },
        ],
      };
    }
      ...
      diagnostics: [
        {
          ...
          severity: "info",
          message: "G9Claw does not resize images; original bytes forwarded (intentional_difference §4.5).",
        },
      ],
    };
  }
      ...
      diagnostics: [
        {
          ...
          severity: "info",
          message: `Estimated ${estimatedPages} pages from ${info.size} bytes (G9Claw does not invoke pdfinfo, intentional_difference §4.5).`,
        },
      ],
    };
  }
